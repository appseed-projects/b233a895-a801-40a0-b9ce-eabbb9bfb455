...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-06 16:41`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b233a895-a801-40a0-b9ce-eabbb9bfb455.git
$ cd b233a895-a801-40a0-b9ce-eabbb9bfb455
```
